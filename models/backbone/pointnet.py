...
class Pointnet_Backbone(nn.Module):
    ...
    def __init__(self, use_fps=False, normalize_xyz=False, return_intermediate=False, input_channels=0):
        ...
        self.FP_modules.append(PointnetFPModule(mlp=[64+input_channels,32,32]))
        self.FP_modules.append(PointnetFPModule(mlp=[192,128,64]))
        self.FP_modules.append(PointnetFPModule(mlp=[256,128,128]))
        self.cov_final = nn.Conv1d(32, 64, kernel_size=1)
